...
**Part B** is to test the Arduino built-in LED with a toggle button. In this part, we are using polling. [video herr](https://youtube.com/shorts/amShUlg6N-8?si=JnKY1JSXmlFZAhjV) <br>
